...
import transformers
from layoutlmft.models.doc_embedding import docEmbeddingModelNoTrain
...
def main():
    ...
    datasets = load_dataset(
        os.path.abspath(layoutlmft.data.datasets.xfun_doc_embedding_no_train.__file__),
    ...
    model = docEmbeddingModelNoTrain.from_pretrained(
