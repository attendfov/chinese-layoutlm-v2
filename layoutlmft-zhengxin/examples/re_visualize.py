...
def draw_rec(img, results, tokens, reindex2label, bbox_src):
...
def process_preds(items, preds_path, filepaths, output_path):
    ...
    for doc_id, doc in docs.items():
        ...
        img_pred = draw_rec(copy.deepcopy(img), pred, tokens, reindex2label, bbox_src)
...
def main_1():
    ...
    items = _generate_examples(preds_path, filepaths, output_path)
    process_preds(items, preds_path, filepaths, output_path)
